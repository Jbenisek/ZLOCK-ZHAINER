...
- **Wall Textures:**
  - North Wall: wall_n.png
  - South Wall: wall_s.png
  - East Wall: wall_e.png
  - West Wall: wall_w.png
  
- **Technical Changes:**
  - Removed experimental video wall system that caused performance issues
  - Restored original static texture implementation using THREE.TextureLoader
  - Cleaned up video-related code and references
  - Fixed startAllWallVideos() function to remove undefined references
